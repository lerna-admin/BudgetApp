...
## Nota sobre perfiles y objetivos
- Cada perfil que se ofrezca (ej.: ahorro intensivo, pago de deudas, inversión activa) debe asociarse a un objetivo claro. Cuando el usuario selecciona o cambia de perfil, el sistema debe registrar ese objetivo y adaptar la guía (mensajes, acciones sugeridas, recordatorios) para alinearse con la intención declarada.
- Alexandra está documentando estos casos de uso; la nota actual sirve como reminder para vincular el backend/frontend con esa fuente y mantener la coherencia durante el sprint.

## Actualización de producto (6 de marzo de 2026)
1. Antes de crear presupuesto, el sistema debe sugerir al usuario nuevo registrar su realidad financiera.
2. La captura mínima de realidad financiera incluye:
   - cuentas bancarias (nombre y saldo),
   - deudas (origen, saldo y tasa EA opcional),
   - metas de ahorro,
   - gastos recurrentes/bills (casa, carro, servicios, celular, administración, etc.).
3. Si una deuda no trae tasa, el sistema usará 23 % EA por defecto (configurable) para estimar intereses y cuota mensual de salida.
4. Durante la creación de presupuesto, deben precargarse automáticamente cuotas de deuda y pagos recurrentes para evitar olvidos.
5. El usuario debe poder crear meta, deuda o cuenta bancaria nueva desde el mismo flujo de presupuesto.
6. Distribución de enfoque acordada:
   - Alexandra: módulo de división de cuentas.
   - Henry: flujo de creación de presupuesto y pasos previos de "realidad financiera".
